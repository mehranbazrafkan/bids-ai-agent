...
class LLM:
    ...
    def chat(
        ...
        # Comment this message it using Gemma-3-270M
        messages = [
            {
                "role": "system",
        ...
        # Uncomment this text if using Gemma-3-270M
        # text = f"""
        # System:
        # {system_prompt}
        ...
        # Comment this text if using Gemma-3-270M
...
class LLMClient:
    ...
    def generate_response(self, system_prompt: str, user_prompt: str) -> str:
        ...
        if not self.model:
            ...
            return f"[LLM Response Simulated for Prompt length {len(user_prompt)}]"

        return self.model.chat(system_prompt, user_prompt)

    def tool_chat(self, system_prompt: str, user_prompt: str, tools_schema: List[Dict[str, Any]]) -> str:
