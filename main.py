...
agent = Agent()
response = agent.run(user_input=user_prompt, context=sample_issue_001)
print(response)
print("---- ---- ---- --|-- ---- ---- ----")
response = agent.run(user_input=user_prompt, context=sample_issue_002)
print(response)
print("---- ---- ---- --|-- ---- ---- ----")
response = agent.run(user_input=user_prompt, context=sample_issue_003)
print(response)
print("---- ---- ---- --|-- ---- ---- ----")
